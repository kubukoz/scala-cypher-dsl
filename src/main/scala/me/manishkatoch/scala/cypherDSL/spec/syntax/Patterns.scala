...
private[spec] object Patterns {
  ...
  object PropertyExists {
    ...
    implicit def implicitProvider[T, H <: HList, PName, PType](implicit
  ...
  implicit final class RichNode[T <: Product](element: T) {

    def apply[TP](
        p1: Witness.Lt[Symbol]
    )(implicit queryProvider: QueryProvider[T], sp1: PropertyExists[T, p1.T, TP]) = {
      Node(element, p1.value :: HNil)
    }

    def apply[TP, TP2](p1: Witness.Lt[Symbol], p2: Witness.Lt[Symbol])(implicit
    ...
    def apply[TP, TP2, TP3](p1: Witness.Lt[Symbol], p2: Witness.Lt[Symbol], p3: Witness.Lt[Symbol])(implicit
        queryProvider: QueryProvider[T],
        sp1: PropertyExists[T, p1.T, TP],
        sp2: PropertyExists[T, p2.T, TP2],
    ...
    def apply[TP, TP2, TP3, TP4, TP5, TP6](
        p1: Witness.Lt[Symbol],
        p2: Witness.Lt[Symbol],
        p3: Witness.Lt[Symbol],
        p4: Witness.Lt[Symbol],
    ...
    def apply[TP, TP2, TP3, TP4, TP5, TP6, TP7](
        p1: Witness.Lt[Symbol],
        p2: Witness.Lt[Symbol],
        p3: Witness.Lt[Symbol],
        p4: Witness.Lt[Symbol],
    ...
    def apply[TP, TP2, TP3, TP4, TP5, TP6, TP7, TP8](
        p1: Witness.Lt[Symbol],
        p2: Witness.Lt[Symbol],
        p3: Witness.Lt[Symbol],
        p4: Witness.Lt[Symbol],
    ...
    def apply[TP, TP2, TP3, TP4, TP5, TP6, TP7, TP8, TP9](
        p1: Witness.Lt[Symbol],
        p2: Witness.Lt[Symbol],
        p3: Witness.Lt[Symbol],
        p4: Witness.Lt[Symbol],
    ...
    def apply[TP, TP2, TP3, TP4, TP5, TP6, TP7, TP8, TP9, TP10](
        p1: Witness.Lt[Symbol],
        p2: Witness.Lt[Symbol],
        p3: Witness.Lt[Symbol],
        p4: Witness.Lt[Symbol],
  ...
  implicit final class EnrichedNode[T <: Product, TH <: HList](element: Node[T, TH]) {
    ...
    def -|[U <: Product, UH <: HList](
        rel: Node[U, UH]
    )(implicit qpU: QueryProvider[U], i0: ToTraversable.Aux[UH, List, Symbol]) = {
    ...
    def -|*[U <: Product, UH <: HList](
        rel: Node[U, UH]
    )(implicit qpU: QueryProvider[U], qpT: QueryProvider[T], i1: ToTraversable.Aux[UH, List, Symbol]) = {
      val variableLengthRelationship = Relationship(rel.element, rel.properties, Option(VariableLengthRelation()))
      new Path(PathLink(None, element, Some("-")), PathLink(None, variableLengthRelationship, None))
    }
    def -|*[U <: Product, UH <: HList](rel: Node[U, UH], length: Int)(implicit
        qpU: QueryProvider[U],
        qpT: QueryProvider[T],
    ...
    def -|*[U <: Product, UH <: HList](rel: Node[U, UH], range: Range)(implicit
        qpU: QueryProvider[U],
        qpT: QueryProvider[T],
        i1: ToTraversable.Aux[UH, List, Symbol]
    ) = {
  ...
  implicit final class RichNodeType(element: NodeType) {
    def --[U <: Product, UH <: HList](rel: U)(implicit qpU: QueryProvider[U]) =
      new Path(PathLink(None, element, Some("-")), PathLink(Some("-"), Node(rel, HNil), None))

    def --[U <: Product, UH <: HList](
        rel: Node[U, UH]
    )(implicit qpU: QueryProvider[U], i1: ToTraversable.Aux[UH, List, Symbol]) =
      new Path(PathLink(None, element, Some("-")), PathLink(Some("-"), rel, None))
    ...
    def -|*[U <: Product, UH <: HList](rel: U, length: Int)(implicit
        qpU: QueryProvider[U],
  ...
  implicit final class RichProduct[T <: Product, TH <: HList](element: T) {
    def --[U <: Product, UH <: HList](rel: U)(implicit qpT: QueryProvider[T], qpU: QueryProvider[U]) =
    ...
    def <-|[U <: Product, UH <: HList](
        rel: Node[U, UH]
    )(implicit qpU: QueryProvider[U], qpT: QueryProvider[T], i0: ToTraversable.Aux[UH, List, Symbol]) = {
      val rels = Relationship(rel.element, rel.properties)
    ...
    def -|[U <: Product, UH <: HList](
      ...
      new Path(
        PathLink(None, Node(element, HNil), Some("-")),
